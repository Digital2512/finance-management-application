...
const debtSchema = new mongoose.Schema({
    ...
    payerGroup: {type: mongoose.Schema.ObjectId, ref: 'User', default: 'Undefined'}//might need to change to string to avoid user not found error due to the sende/receiver not being a registered user in the database
});
