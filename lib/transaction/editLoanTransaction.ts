...
export const editLoanTransaction = async ( 
    ...
    newInterestRateAmount: string,
    newTypeOfInterest: string,
    ...
    try {
      ...
      const addNewLoan = new Loan({
        ...
        interestRateAmount: newInterestRateAmount,
        typeOfInterest: newTypeOfInterest,
      ...
      const token = authMiddleware({ userID: addNewLoan._id, username: addLoanTransaction.name, expiresInAmount: '1h'}, 'sign');
