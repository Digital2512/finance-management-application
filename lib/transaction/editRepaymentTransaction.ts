...
export const editRepaymentTransaction = async ( 
    ...
    try {
      ...
      const addNewLoan = new Repayment({
        userID: userID,
        debtID: newDebtID,
      ...
      if(token){
        ...
        return { result: true, token: token, message: 'Edit Transaction Successful', deletedTransactionID: oldRepaymentTransactionID, newTransactionID: addNewLoan._id};
      }
