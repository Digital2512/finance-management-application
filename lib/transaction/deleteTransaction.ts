...
export const deleteTransaction = async ( 
    ...
    console.log('Delete Transaction with ID:', { _id: transactionID }); // Log the incoming data
    ...
    try {
      ...
      if (!existingTransaction) {
        ...
        const deleteOldTransaction = await Transaction.deleteOne({_id: transactionID})
        ...
        return { result: true, message: 'Transaction deleted', deletedTransactionID: transactionID};
      }
  } catch (error) {
